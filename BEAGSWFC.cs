...
public class BEAGSWFC : MonoBehaviour
{
    ...
    private void CollapseWorld()
    {
        ...
        while (_toCollapse.Count > 0)
        {
            ...
            {
                //Delete game object here if there is one using ray cast then instantiate the new one
    ...
    {
        int buildingX = Random.Range(1, Width);
        int buildingY = Random.Range(1, Height);

        Debug.Log(buildingX + buildingY);
